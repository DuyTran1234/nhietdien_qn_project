...
export default function CreateHopDongThueDat() {
    ...
    const onFinish = async (values: any) => {
        ...
        try {
            ...
            setIsLoading(false);
            message.success('Tạo hợp đồng thuê đất mới thành công!');
            navigate(PATHS.LIST_HOP_DONG);
        } catch (error) {
            setIsLoading(false);
            message.error('Tạo hợp đồng thuê đất mới thất bại, vui lòng kiểm tra lại thông tin nhập');
        }
    };
        ...
        <div style={{ padding: '24px' }}>
            ...
            <Card>
                ...
                >
                    ...
                    <Row gutter={16}>
                        <Col span={8}>
                            <Form.Item label="Mục đích thuê" name="mucDichThue" rules={[{ required: true }]}>
                                <TextArea rows={2} />
                            </Form.Item>
                        </Col>
                        <Col span={8}>
                            <Form.Item label="Khu vực thuê" name="khuVucThue" rules={[{ required: true }]}>
                                <Input />
                            </Form.Item>
                        </Col>
                        <Col span={8}>
                            <Form.Item label="Vị trí thuê" name="viTriThue" rules={[{ required: true }]}>
                                <Input />
                            </Form.Item>
                        </Col>
                    </Row>
